...
public class TitleBarControlCenter {
    ...
    @Nullable
    public static <T> T initTitle(final Activity activity, View rootView, String title, boolean displayHomeEnable, OnKeyboardListener onKeyboardListener, boolean keyboardEnable) {
        ...
        if (barView instanceof Toolbar) {
            ...
            return (T) toolbarManager.initToolbar((Toolbar) barView, title, displayHomeEnable, onKeyboardListener, keyboardEnable);

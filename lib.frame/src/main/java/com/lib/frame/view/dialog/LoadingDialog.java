...
public class LoadingDialog {
    ...
    public static MaterialDialog show(Context context, String title, String content) {
        dismiss();
    ...
    public static MaterialDialog show(Context context, int title, int content) {
        return show(context, context.getString(title), context.getString(content));
    }

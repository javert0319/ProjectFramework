...
public class MovieFragmentPagerAdapter extends FragmentStatePagerAdapter {
     ...
     * 普通，主页使用
     */
    public MovieFragmentPagerAdapter(FragmentManager fm, List<?> mFragment) {
        super(fm);
     ...
     * 接收首页传递的标题
     */
    public MovieFragmentPagerAdapter(FragmentManager fm, List<?> mFragment, List<String> mTitleList) {
        super(fm);
        this.mFragment = mFragment;
